...
import { url_lease_customer_detail } from '../../../../../url/url';
...
class CustomerDetail extends Base {
    detailUrl = url_lease_customer_detail;
    /**
     * 详情页面头部的按钮事件
     */
    detailHeaderCon = {
        btns:[
            {
                ...
                handle: () => {
                    console.log('编辑', this);
                    this.context.router.history.push('/admin/customer-edit/update');
                }
            }, 
            {
                title: '锁定',
    ...
    init() {
        ...
        this.detail().then(data => {
            ...
            detailHeaderCon.title = data.resultData.customerName;
            this.setState({
                detailHeaderCon,
